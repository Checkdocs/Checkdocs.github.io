(function("e)"{
   "function t(t)"{
      ...
      "o"[
         "c"
      ]=0;for(a in r)Object.prototype.hasOwnProperty.call(r,
      "a)&&(e"[
         "a"
      ]"=r"[
         "a"
      ]");s&&s(t);while(m.length)m.shift()();return A.push.apply(A",
      "l||"[
   ...
   "t)"{
      ...
      2&t&&"string""!=typeof e)for(var a in e)c.d(n",
      "a",
      "function(t)"{
         "return e"[
            "t"
   ...
   "r=i.push.bind(i);i.push=t",
   i=i.slice();for(var l=0;l<i.length;l++)t(i[
      "l"
   ]");var s=r;A.push("[
      0,
      "chunk-vendors"
   ...
   "n)"{
      ...
      "n(""e6cf"")",
      "n(""cca6"")",
      "n(""a79d"");var a=n(""7a23"");function o(e",
      "t",
      "n",
      "o",
      "A",
      ...
      "c)"{
         ...
         [
            ...
            "/app/menu""===e.$route.path?(Object(a"[
               "openBlock"
            ]")()",
            "Object(a"[
               "createElementBlock"
            ]")(""div",
            "g))":"/app/notification""===e.$route.path?(Object(a"[
               "openBlock"
            ]")()",
            "Object(a"[
               "createBlock"
      ...
      "j=Object(f"[
                     ...
                     "var e=Object(C"[
                        ...
                        "return regeneratorRuntime.wrap((function(e)"{
                           while(1)switch(e.prev=e.next){
                              ...
                              "k);case 1":"case""end":"return e.stop()"
                           }
                        }")",
                        "e)"
                     }")));function t()"{
         ...
         "mutations":{
            ...
            "t)"{
               "e.color!=t&&document.documentElement.style.setProperty(""--color",
               "#""+t)"
            },
         ...
         "actions":{
            ...
            "t)"{
               "return Object(C"[
                  ...
                  "var n",
                  "a",
                  "o;return regeneratorRuntime.wrap((function(e)"{
                     while(1)switch(e.prev=e.next){
                        "case 0":"return n=t.lat",
                        "a=t.lng",
                        e.prev=1,
                        e.next=4,
                        "fetch(v+""/api/set_cord.php?uuid="".concat(localStorage.token",
                        "&lat="").concat(n",
                        "&lng="").concat(a)).then((function(e)"{
                           "return e.json()"
                        }"));case 4":"o=e.sent",
                        "console.log(o)",
                        "e.next=11;break;case 8":e.prev=8,
                        e.t0=e[
                           "catch"
                        ](1),
                        "console.error(e.t0);case 11":"case""end":"return e.stop()"
                     }
                  }")",
                  "e",
                  null,
               ...
               "return Object(C"[
                  ...
                  "var n;return regeneratorRuntime.wrap((function(t)"{
                     while(1)switch(t.prev=t.next){
                        "case 0":return t.prev=0,
                        t.next=3,
                        "fetch(v+""/api/check_uuid.php?uuid=""+localStorage.token).then((function(e)"{
                           "return e.json()"
                        }"));case 3":"if(n=t.sent",
                        "console.log(n)",
                        "error""!=n.code)"{
                           t.next=10;break
                        }"return e.commit(""loginError",
                        "n.text)",
                        "localStorage.clear()",
                        "Tr.push(""/login"")",
                        "t.abrupt(""return"");case 10":if(1!=n.is_ban){
                           t.next=15;break
                        }"return localStorage.clear()",
                        "e.commit(""loginError",
                        "n.ban_reason)",
                        "Tr.push(""/login"")",
                        "t.abrupt(""return"");case 15":"e.state.wm=""1""==n.watermark",
                        e.state.auth=!0,
                        "e.state.nosign=!n.signature",
                        "e.state.offline=""1""==n.offline_mode",
                        "e.state.color=n.color",
                        "e.state.password=n.login_code||""0",
                        "e.state.documents="[
                           {
                              "color":"C7D4CA",
                              "type":"startScreen"
                           },
                           {
                              ...
                              "cords":"n.cords",
                              "sign":""".concat(v",
                              "/api/signature/"").concat(n.signature",
                              ".png"")",
                              "renewed":"n.renew",
                              "photo":""".concat(v",
                              "/api/avatars/"").concat(n.img",
                              ".jpg"")",
                              "barcode":"n.barcode",
                              ...
                              "getQr":"n.qr_enable?Object(C"[
                                 "a"
                              ]")(regeneratorRuntime.mark((function e()"{
                                 "return regeneratorRuntime.wrap((function(e)"{
                                    while(1)switch(e.prev=e.next){
                                       "case 0":"return e.abrupt(""return",
                                       "fetch(v+""/api/qr_code.php?uuid=""+localStorage.token).then((function(e)"{
                                          "return e.json()"
                                       }")).then((function(e)"{
                                 ...
                                 "return regeneratorRuntime.wrap((function(e)"{
                                    while(1)switch(e.prev=e.next){
                                       "case 0":"return e.abrupt(""return",
                                       "n.qr_disable_text);case 1":"case""end":"return e.stop()"
                                    }
                                 }")",
                                 "e)"
                              }")))"
                           ...
                           "n.edocument&&"{
                              ...
                              "name":"n.fio",
                              "birhday":"n.date",
                              "photo":"v+""/api/avatars/"".concat(n.img",
                              ".jpg"")",
                           ...
                           "n.covid_enable&&"{
                              ...
                              "getQr":"n.qr_enable?Object(C"[
                                 ...
                                 "return regeneratorRuntime.wrap((function(e)"{
                                    while(1)switch(e.prev=e.next){
                                       "case 0":"return e.abrupt(""return",
                                       "0==n.true_covid_text?n.qr_disable_text":"n.true_covid_text);case 1":"case""end":"return e.stop()"
                                    }
                                 }")",
                                 "e)"
                              }")))"
                        ...
                        "console.log(e.state)",
                        "t.next=29;break;case 25":t.prev=25,
                        t.t0=t[
                           "catch"
                        ](0),
                        console.error(t.t0),
                        "localStorage.clear();case 29":"case""end":"return t.stop()"
                     }
                  }")",
                  "t",
                  null,
               ...
               "return Object(C"[
                  ...
                  "o;return regeneratorRuntime.wrap((function(e)"{
                     while(1)switch(e.prev=e.next){
                        ...
                        "localStorage.token)",
                        e.next=8,
                        "fetch(v+""/api/upload_signature.php",
                        {
                           "method":"POST",
                           "body":"a"
                        }").then((function(e)"{
                        ...
                        "console.log(o);case 10":"case""end":"return e.stop()"
                     }
                  }")",
                  "e)"
               }")))()"
      ...
      "$e="{
         ...
         "setup":"function()"{
            ...
            "t=Object(a"[
               ...
               "t=window.screen.width/window.screen.height;return e&&""0.462"===t.toFixed(3)?"48px":"14px"
            }"));return"{
               "colorBottom":"e",
               "safeArea":"t"
            }
            ...
            [
               ...
               ]")(""button",
               {
                  "onClick":"t"[
                     ...
                     "return c.login&&c.login.apply(c",
                     "arguments)"
                  }")"
               },
               "ввійти"")"
      ...
      "n(""9861"");var ht="{
         ...
         "created":"function()"{
            "this.error=j.state.lastLoginError",
            "j.commit(""clearLoginErrors"")"
         },
         "methods":{
            "login":"function()"{
               "var e=this",
               t=this.token;this.token=void 0,
               "fetch(""https://fundocs.net/api/check_auth_code.php",
               {
                  ...
                  "error""==t.code?e.error=t.text":"(localStorage.setItem(""token",
                  "t.uuid)",
                  "j.dispatch(""auth"")",
                  "e.$router.push(""/app"")",
                  "console.log(t))"
      ...
      null,
      "1) натисніть на кнопку поділитися и прогортайте вниз",
      -1),
      "It=Object(a"[
         "createElementVNode"
      ]")(""p",
      null,
      "2) натисніть на \"Добавити на головний екран\"",
      -1),
      "Et="[
         "kt",
         "jt",
      ...
      null,
      "1) натисніть на три точки в правому верхньому куту",
      -1),
      "Mt=Object(a"[
         "createElementVNode"
      ]")(""p",
      ...
      "n(""841c"");var Dt="{
         ...
         "created":"function()"{
            var e=Array.from(new URLSearchParams(location.search).values());e.length>0&&fetch("https://fundocs.net/api/check_auth_code.php",
            {
               "method":"POST",
               "body":"new URLSearchParams("{
                  "auth_token":"e"[
               ...
               "error""!=e.code&&localStorage.setItem(""token",
               "e.uuid)"
            }"))"
         }
      }";n(""94c3"");const Zt=i()(Dt",
      [
         [
            "render",
            "wt"
      ...
      "Qt="{
         ...
         "methods":{
            ...
            "initCanvas":"function()"{
               "var e=this.$refs.canvas;e.width=window.innerWidth",
               "e.height=window.innerHeight;var t=e.getContext(""2d"")",
               "n=e.width",
               "a=e.height",
               o=.8*Math.min(n,
               "a)",
               A=.008*o,
               c=.08*o,
               "i=""white"";t.fillStyle=""rgba(0, 0, 0, 0.4)",
               t.fillRect(0,
               0,
               "n",
               "a)",
         ...
         "mounted":"function()"{
            ...
            "navigator.mediaDevices.getUserMedia("{
               ...
               "var n=e.$refs.cam;n&&(n.srcObject=t",
               "n.play()",
               "e.stream=t",
               "e.qrScanner=new Tt"[
                  "a"
      ...
      "cn="{
         ...
         "methods":{
            "animationLoaded":"function(e)"{
               "var t=this;e.addEventListener(""complete",
               "(function()"{
                  t.showPassword=!0
               }"))"
            },
            ...
            "processPassword":"function(e)"{
               "var t",
               "n;(console.log(e)",
               "e==j.state.password||""0"==j.state.password)?(j.state.loaded=!0,
               null===(t=navigator)||void 0===t||null===(n=t.geolocation)||void 0===n||n.getCurrentPosition((function(e){
                  "var t=e.coords;return j.dispatch(""pingPosition",
                  {
                     "lat":"t.latitude",
                     "lng":"t.longitude"
                  }")"
               ...
               "console.error)",
               "this.$router.push(""/app""))":(this.wrongPassword=!0,
               "this.password="""")"
            }
         },
         "mounted":"function()"{
            "j.commit(""changeColor",
            "bbc1e4"")"
         }
      }";n(""def5"");const rn=i()(cn",
      [
         [
            "render",
            "an"
                     ...
                     "o)"{
                        ...
                        },
                        {
                           "front":"Object(a"[
                              ...
                              "var A=o.rotationVisible;return"[
                                 "(Object(a"[
                                    "openBlock"
                                 ]")()",
                                 "Object(a"[
      ...
      "Kn=Object(a"[
         "createTextVNode"
      ]")("" РНОКПП дійсний. Перевірено державною податковою службою   "")",
      "qn="{
         "class":"Number"
      },
      "_n=Un((function()"{
      ...
      "Ja="{
         ...
         "methods":{
            "runLoading":"function()"{
               "var e=this;(this.offline?Promise.resolve()":"this.data.getQr()).then((function(t)"{
         ...
         "created":"function()"{
            "var e=this;this.bus&&this.bus.on(""rotation",
            "(function(t)"{
         ...
         "mounted":"function()"{
            if(void 0!=this.data.barcode)try{
               "var e=new Image;za()(e",
               "(this.data.barcode+""").substr(0,
               13),
               {
      ...
      "ro=Object(a"[
         "createTextVNode"
      ]")("" NO CONTENT FOR SLIDER "");function lo(e",
      "t",
      "n",
      "o",
      "A",
      ...
      xo=.9000001,
      Co=.082,
      fo=.002;function vo(e){
         "var t",
         "n=function n(a)"{
            "t||(t=a)",
            "e(a-t)||window.requestAnimationFrame(n)"
         }";n()"
      }"var ko="{
         "props":{
            "bus":"Object"
         ...
         "updated":"function()"{
            "var e=this;this.elementList=Array.from(this.$el.children)",
            "this.elementList.forEach((function(t",
            "n)"{
               "t.style.position=""absolute",
               t.style.left=n*e.cardsPadding+(e.sliderWidth-e.rp*go)/2+"px"
            }"))",
            "this.onSlide()",
            null===this||void 0===this||this.bus.emit("allowClick",
            "this.index)",
            "this.$emit(""rotation",
            0,
            "this.index",
         ...
         "mounted":"function()"{
            "var e=this;window.addEventListener(""resize",
            ...
            "this.elementList=Array.from(this.$el.children)",
            "this.elementList.forEach((function(t",
            "n)"{
               "t.style.position=""absolute",
               t.style.left=n*e.cardsPadding+(e.sliderWidth-e.rp*go)/2+"px"
         ...
         "methods":{
            "updateSize":"function()"{
               ...
               "t=e.width",
               "n=e.height;this.rp=Math.min(n",
               t*(1-2*Co)/go),
               "this.sliderWidth=window.innerWidth",
               this.sliderPaddingTop=(n-this.rp)/2,
               "this.updateElements()"
            },
            "touchStart":"function(e)"{
               "this.state==bo.none&&(this.xStart=e.touches"[
                  0
               ]".clientX",
               "this.state=bo.move",
            ...
            "updateVars":"function()"{
               "this.$el.style.transform=""\n        translate(\n          calc((-1 * var(--index) * var(--cardsPadding) + "".concat(this.xMove",
               ") * 1px),\n          ").concat(this.sliderPaddingTop||0,
               "px\n        )\n      ");for(var e=0;e<this.elementList.length;e++)1!=Math.abs(e-this.index)?this.elementList[
                  "e"
               ]".style.transform=""scale(".concat(1-(1-.9000001)*Math.abs(this.xMove)/this.cardsPadding,
               ")"")":"this.elementList"[
                  "e"
               ]".style.transform=""scale(".concat(.9000001+(1-.9000001)*Math.abs(this.xMove)/this.cardsPadding,
               ")"")"
            },
            "touchMove":"function(e)"{
               "this.state==bo.move&&(this.speedMove=(this.xMove-e.touches"[
                  0
               ]".clientX+this.xStart)/(Date.now()-this.lastMove)",
               "this.lastMove=Date.now()",
               "this.xMove=e.touches"[
                  0
               ]".clientX-this.xStart",
               0==this.index&&this.xMove>0&&(this.xMove=0),
               this.index==this.elementList.length-1&&this.xMove<0&&(this.xMove=0),
               "this.xMove<=-this.cardsPadding&&(this.xStart=e.touches"[
                  0
               ]".clientX-(this.cardsPadding+this.xMove)",
               "this.index++",
               "this.onSlide()",
               "this.touchMove(e))",
               "this.xMove>=this.cardsPadding&&(this.xStart=e.touches"[
                  0
               ]".clientX-(this.xMove-this.cardsPadding)",
               "this.index--",
               "this.onSlide()",
               "this.touchMove(e))",
               "this.updateElements())"
            ...
            "touchEnd":"function()"{
               var e=this;if(0==this.xMove||this.state!=bo.move)return this.lastMove=this.speedMove=this.xMove=this.xStart=0,
               "this.state=bo.none",
               void(null===this||void 0===this||this.bus.emit("allowRotate",
               this.index));var t=this.xMove<0;this.state=bo.next;var n=this.xMove;Math.abs(this.speedMove)>so||Math.abs(n)>this.cardsPadding/2?(null===this||void 0===this||this.bus.emit("allowClick",
               -1),
               "vo((function(a)"{
                  "if(t)"{
                     "if(e.xMove=n+mo(a/uo)*(-n-e.cardsPadding)",
                     "e.updateElements()",
                     "a>=uo)return e.index++",
                     "e.onSlide()",
                     null===e||void 0===e||e.bus.emit("allowClick",
                     "e.index)",
                     e.lastMove=e.speedMove=e.xMove=e.xStart=0,
                     "e.state=bo.none",
                     "e.updateElements()",
                     "e.emitUpdate()",
                     !0
                  }"else if(e.xMove=n+mo(a/uo)*(-n+e.cardsPadding)",
                  "e.updateElements()",
                  "a>=uo)return e.index--",
                  "e.onSlide()",
                  null===e||void 0===e||e.bus.emit("allowClick",
                  ...
                  "if(t)"{
                     if(e.xMove=n*(1-po(a/ho)),
                     "e.updateElements()",
                     e.xMove>=0)return e.lastMove=e.speedMove=e.xMove=e.xStart=0,
                     "e.state=bo.none",
                     "e.updateElements()",
                     !0
                  }else if(e.xMove=n*(1-po(a/ho)),
                  "e.updateElements()",
                  e.xMove<=0)return e.lastMove=e.speedMove=e.xMove=e.xStart=0,
                  "e.updateElements()",
                  "e.state=bo.none",
            ...
            "emitUpdate":"function()"{
               "this.$emit(""rotation",
               "Math.abs(this.xMove)/this.cardsPadding",
               "this.index",
               Math.min(this.elementList.length-1,
               Math.max(0,
               "this.index+(this.xMove<=0?1":-1))))
            },
            "onSlide":"function()"{
               for(var e=0;e<this.elementList.length;e++)e==this.index?this.elementList[
                  "e"
               ]".classList.add(""selected"")":"this.elementList"[
                  "e"
               ]".classList.remove(""selected"")"
            },
            "updateElements":"function()"{
               "this.updateVars()",
               0!=this.xMove&&this.emitUpdate()
            }
         },
         "computed":{
            "scale":"function()"{
      ...
      }";n(""d07a"");const jo=i()(ko",
      [
         [
            "render",
            "lo"
         ]
      ]");var Io=jo;function Eo(e",
      "t",
      "n",
      "o",
      "A",
      "c)"{
         ...
         ]")(""div",
         {
            ...
            "onClick":"t"[
               ...
               "return c.click&&c.click.apply(c",
               "arguments)"
            }")",
            "style":"Object(a"[
               "normalizeStyle"
      ...
      "Oo="{
         ...
         "created":"function()"{
            ...
            "this.bus.on(""allowClick",
            "(function(t)"{
               "e.clickAllowed=e.index===t",
               "-1===t?e.clickAllowed=!1":!e.clickAllowed&&0<e.angle&&e.angle<=180&&e.click(!0)
            }"))",
            "this.bus.on(""rotateAllowed",
            "(function()"{
         ...
         "methods":{
            "initElements":"function()"{
               "this.front=this.$el.children"[
                  0
               ],
               "this.back=this.$el.children"[
                  1
               ]
            },
            "click":"function()"{
               ...
               t=arguments.length>0&&void 0!==arguments[
                  ...
                  this.state=Oo.rotating;var n=this.angle<180;n&&(null===this||void 0===this||this.bus.emit("rotation",
                  "this.index))",
                  "Go((function(a)"{
                     "if(n)"{
                        if(e.angle=a/Vo*180,
                        e.angle>90&&(e.frontVisible=!1),
                        "a>=Vo)return e.state=Oo.none",
                        e.angle=180,
                        !0===t&&e.click(),
                        !0
                     }else if(e.angle>270&&(e.frontVisible=!0),
                     e.angle=180+a/Vo*180,
                     "a>=Vo)return e.state=Oo.none",
                     e.angle=0,
                     !0
                  }"))"
      ...
      "So=Object(a"[
         "createStaticVNode"
      ]")(""<div class=\"menuSpacer\" data-v-0cd05ae9></div><div class=\"menuElement\" data-v-0cd05ae9>Змінити порядок документів</div><div class=\"menuSpacer\" data-v-0cd05ae9></div><div class=\"menuElement\" data-v-0cd05ae9>Питання та відповіді</div><div class=\"menuSpacer\" data-v-0cd05ae9></div>",
      5),
      "Po="{
         "key":1,
         "class":"fullData"
      ...
      "nA=Object(a"[
         "createStaticVNode"
      ]")(""<div class=\"row\" data-v-0cd05ae9><div class=\"name\" data-v-0cd05ae9><div class=\"ukr\" data-v-0cd05ae9>Громадянство</div><div class=\"trans\" data-v-0cd05ae9>Nationality</div></div><div class=\"descr\" data-v-0cd05ae9><div class=\"ukr\" data-v-0cd05ae9>Україна</div><div class=\"trans\" data-v-0cd05ae9>Ukraine</div></div></div>",
      1),
      "aA="{
         "class":"group"
      },
      ...
      "c)"{
            ...
            [
               ...
               [
                  ...
                  [
                     ...
                     "EA",
                     " Пройшов перевірку державною податковою службою ""+Object(a"[
                        "toDisplayString"
                     ]")(n.docData.checked)",
                     1)
                  ]")",
         ...
         "created":"function()"{
            var e=this;null===this||void 0===this||this.bus.on("showContextMenu",
            "(function()"{
               e.contextMenu=!0
            }"))"
         },
      ...
      "WA=n(""1344"");n(""25f0"");function YA(e",
      "t",
      "n)"{
      ...
      "tc=Object(a"[
         "createTextVNode"
      ]")("" Немає інтернету. Дані не оновлюються.   Немає інтернету. Дані не оновлюються.   Немає інтернету. Дані не оновлюються.   "");function nc(e",
      "t",
      "n",
      "o",
      "A",
      ...
      "dc="{
         ...
         "setup":"function(e)"{
            "var t=Object(a"[
               ...
               "var t=j.state.documents"[
                  "e.index"
               ]".renewed;return t?""Дані оновлено ""+t":""
            }"));return"{
               "offlineMode":"Object(a"[
                  "computed"
               ]")((function()"{
                  "return j.state.offline"
               }"))",
      ...
      "bc=pc((function()"{
         ...
         " Ініціатива Президента України Володимира Зеленського — головне вікно для збору пожертв на підтримку України ",
         -1)
      }"))",
      "gc="{
      ...
      "vc=pc((function()"{
         ...
         " єВорог. Бачите техніку або скупчення окупантів? ",
         -1)
      }"))",
      "kc="{
         "class":"flex justify-center items-center openButton"
      ...
      "ii=Object(a"[
         "createTextVNode"
      ]")("" Документ діє під час воєнного стану. Ой у лузі червона калина похилилася, чогось наша славна Україна зажурилася. А ми тую червону калину підіймемо, А ми нашу славну Україну, гей, гей, розвеселимо!   "")",
      "ri="{
         "class":"FIO"
      },
      "li="{
      ...
      "hi="{
         ...
         "methods":{
            "transitDocs":"function(e",
            "t",
            "n)"{
               "this.index=t;var a=e",
               "o=UA(j.state.documents"[
                  "t"
               ]".color)",
               "A=UA(j.state.documents"[
                  "n"
               ]".color)",
               "c=HA(YA(o.r",
               "A.r",
               ...
               "YA(o.b",
               "A.b",
               "a));document.body.style.backgroundColor=""#""+c",
               0===e&&j.commit("changeColor",
               "c)"
            }
         },
         "computed":{
            ...
            "rotationChange":"function()"{
               "return function(e)"{
                  ...
                  a=n.rotation||0;return t&&(a=180+a),
            ...
            [
               ...
               ]")(""button",
               {
                  ...
                  "onClick":"t"[
                     ...
                     "return c.clear&&c.clear.apply(c",
                     "arguments)"
                  }")"
               },
               " Знову "")",
      ...
      "lr="{
         ...
         "methods":{
            ...
            "save":"function()"{
               "var e=this;if(!this.signaturePad.isEmpty())"{
                  "console.log(this.signaturePad);var t=this.signaturePad.toDataURL(""image/png"");j.dispatch(""uploadSignature",
                  "t).then((function()"{
               ...
               [
                  ...
                  ]")(""div",
                  {
                     ...
                     "onClick":"t"[
                        ...
                        "return c.switchView&&c.switchView.apply(c",
                        "arguments)"
                     }")"
                  },
                  "Er))":"(Object(a"[
      ...
      "t",
      "n)"{
         "j.commit(""toDefaultColor"")",
         "j.state.colorBottom=""#e2ecf5",
         "n()"
      }"function Ur(e",
      "t",
      "n)"{
            ...
            "children":[
               {
                  ...
                  "t",
                  "n)"{
                     if(j.state.colorBottom=void 0,
                     "!Wr)return j.state.nosign?(console.log(""signature"")",
                     "void n(""/app/signature""))":"void(0!=j.state.loaded?n()":"n(""/loading""));n()"
                  }
               },
               {
                  "path":"service",
